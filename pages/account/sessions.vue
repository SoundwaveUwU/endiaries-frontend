        ...
        <div class="max-w-full overflow-auto">
            ...
            >
                <thead class="dark:bg-gray-700 bg-gray-100">
                    <tr>
                        <th class="px-3 py-2">Device / OS / Browser</th>
                        <th class="px-3 py-2">Location</th>
                        <th class="px-3 py-2">IP</th>
                        <th class="px-3 py-2">Logged in at</th>
                ...
                <tbody>
                    ...
                    >
                        <td class="px-3 py-2 flex space-x-3 py-3 text-3xl">
                            <span :class="getDeviceIcon(session)"></span>
                            <span :class="getPlatformIcon(session)"></span>
                            <span :class="getBrowserIcon(session)"></span>
                        </td>
                        <td class="px-3 py-2">Moscow, Russia</td>
                        <td class="px-3 py-2">127.***.***.1</td>
                    ...
                    <tr v-if="sessions.links.next !== null">
                        <td colspan="99" align="center" class="p-5">
                            <app-button
                                ...
                                @click="loadNextPage"
                                >Load older sessions</app-button
                            >
                        </td>
                    </tr>
                </tbody>
