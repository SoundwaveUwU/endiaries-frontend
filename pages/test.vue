                ...
                <app-card
                    ...
                    <div class="relative">
                        ...
                        <img
                            ...
                            alt="">
                        <span
                            class="absolute bottom-1 left-1 px-3 py-1 bg-opacity-25 bg-gray-800 text-white rounded">{{ clientWidth }}</span>
                    </div>
                    <div class="p-3">
                        Some post text
                    </div>
    ...
    computed: {
        sizes () {
            ...
            for (const key in this.widths) {
                ...
                if (breakpoint !== 640) { result.push(`(min-width: ${breakpoint}px) ${width}px`) }
            }
